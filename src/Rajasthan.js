        ...
        <main className="main">
            ...
            <h2 className="section__title">Discover the most <br/> attractive places</h2>
                ...
                <div className="place__container container grid">
                    ...
                    <div className="place__card">
                        ...
                        <div className="place__content">
                            ...
                            <div className="place__data">
                                ...
                                <span className="place__subtitle"><a href='https://maps.app.goo.gl/vFyvQP8xcaxMevhy9' target='_blank'>Connaught Place, Sansad Marg, New Delhi, Delhi 11000128C9+Q5Q, Bikaner Fort, Bikaner, Rajasthan 334001</a></span>
                            </div>
                        </div>
                    ...
                    <section className="place section" id="place">
                    <h2 className="section__title">Discover Hotels</h2>
